  ...
  return (
    <div className="min-h-screen bg-[#e6eef6] font-sans flex flex-col antialiased">
      ...
      <main className={`pt-20 px-6 mx-auto w-full transition-all duration-500 pb-40 ${showResult ? 'max-w-5xl' : 'max-w-3xl'}`}>
        {!showResult && activeTab === 'home' && <Dashboard profile={profile} setActiveTab={setActiveTab} setChatHistory={setChatHistory} setShowLegal={setShowLegal} archives={archives} setResult={setResult} setShowResult={setShowResult} />}
